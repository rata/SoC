...
set id 1
set name rgb_to_bw_am_addmul_9ns_8ns_12ns_22_1
...
set out_width 22
set exp (i0+i1)*i2
set arg_lists {i0 {9 0 +} i1 {8 0 +} s {10 0 +} i2 {12 0 +} p {22 0 +} c_expval {c} }
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 2 \
			corename rgb_to_bw_AXILiteS_axilite \
			name rgb_to_bw_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler rgb_to_bw_AXILiteS_s_axi
}
