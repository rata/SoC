...
architecture behave of mul_AXILiteS_s_axi is
    ...
    signal int_a               : UNSIGNED(7 downto 0);
    signal int_b               : UNSIGNED(7 downto 0);
    ...
    begin
        if (ACLK'event and ACLK = '1') and ACLK_EN = '1' then
            if (ar_hs = '1') then
                ...
                when ADDR_A_DATA_0 =>
                    rdata_data <= RESIZE(int_a(7 downto 0), 32);
                when ADDR_B_DATA_0 =>
                    rdata_data <= RESIZE(int_b(7 downto 0), 32);
                when others =>
                    rdata_data <= (others => '0');
                end case;
            end if;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_A_DATA_0) then
                    int_a(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_a(7 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_B_DATA_0) then
                    int_b(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_b(7 downto 0));
                end if;
            end if;
        end if;
    end process;
